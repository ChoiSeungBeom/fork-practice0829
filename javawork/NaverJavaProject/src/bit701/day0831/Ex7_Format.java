...
public class Ex7_Format {
	...
	public static void main(String[] args) {
		...
		//패턴 1
		SimpleDateFormat dateFormat1=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss EEE");//MM:월 mm:분 EEE:요일짧게 HH:24시간기준
		System.out.println(dateFormat1.format(date));
		
		//패턴 2
		SimpleDateFormat dateFormat2=new SimpleDateFormat("yyyy년MM월dd일 a hh:mm:ss EEEE");//a:오전/오후 EEEE:요일길게 hh:12시간기준
